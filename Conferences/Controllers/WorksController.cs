...
namespace Conferences.Controllers
{
    public class WorksController : Controller
    {
        ...
        public WorksController(istatpContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WorkId,ParticipantId,Title,Topic,PublicationDate,ConferenceId")] Work work)
        {
            if (id != work.WorkId)
            {
                return NotFound();
